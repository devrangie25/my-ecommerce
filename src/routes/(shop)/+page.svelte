...
<div class="grid gap-y-28">
	<div class="md:px-14 card h-screen img-container">
		...
		<div class="centered-text">
			<div class="lg:text-7xl text-6xl landing-text uppercase font-semibold font-harmonia">
				{landing_text}
			</div>
			<div class="mt-4 lg:text-5xl text-4xl landing_sub_text uppercase font-frank">
				{landing_sub_text}
			</div>
			<div class="mt-6">
				<button
					class="btn bg-white text-primary border-0 rounded-full px-6 shop-now-btn hover:bg-primary hover:text-white"
	...
	<div class="md:px-14 px-6 grid md:grid-cols-2 gap-x-10">
		<div class="md:order-first order-last md:mt-0 mt-12 flex justify-center items-center">
			<div class="text-center">
				<div class="font-semibold text-primary md:text-6xl text-4xl mb-4 font-harmonia">
					The 24/7 Trainer
				</div>
				<div class="text-primary md:text-6xl text-4xl font-normal font-frank">Meet Rangie.</div>
				<div class="lg:mt-12 mt-6">
					<button
						class="btn btn-primary border-0 rounded-full px-6 text-white font-semibold font-harmonia"
						>Shop Now</button
					>
				</div>
			</div>
		...
		<div>
			<!-- svelte-ignore a11y-img-redundant-alt -->
			<img class="rounded-xl" src={secondImage} alt="Second Landing Image" loading="lazy" />
		</div>
	</div>
