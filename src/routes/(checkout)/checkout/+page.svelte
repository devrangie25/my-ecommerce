<script lang="ts">
	...
	import CheckoutAppBar from '$lib/components/frame/+checkout-app-bar.svelte';
...
<div>
	<div class="grid grid-cols-2 h-screen">
		<!-- Customer Details -->
		<div class="col-span-1 bg-white pl-80">
			<div class="p-8">
				<div class="flex flex-col w-full border-opacity-50">
					...
					<div>
						<form action="">
                            ...
                            <button class="btn btn-primary btn-block rounded h-14 text-lg" type="submit">Pay now</button>
						</form>
					</div>
				</div>
			</div>
		...
		<!-- Cart Details -->
		<div class="col-span-1 items-container w-screen pr-80">
			<div class="p-8">Items here</div>
		</div>
	</div>
</div>
